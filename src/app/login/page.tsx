  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col p-8">
        ...
        {/* Back link */}
        <Link href="/" className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors mb-8 w-fit">
            ...
            <form onSubmit={handleLogin}>
              <CardContent className="space-y-4">
                ...
                <div className="bg-muted/50 rounded-lg p-3 text-sm text-muted-foreground">
                  <p className="font-medium mb-1">Démo :</p>
                  <p>Entrez n'importe quel email/mot de passe pour tester</p>
                </div>
              </CardContent>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/10 via-primary/5 to-accent/10 items-center justify-center p-8">
        ...
        >
          ...
          <p className="text-muted-foreground">
            La plateforme géospatiale de référence en Côte d'Ivoire. 
            Visualisez, analysez et partagez vos données géographiques en toute simplicité.
          </p>
